...
final class EntityViewResolver
{
    ...
    private function builtinDefaults(string $entityType, string $view): array
    {
        $compactDefaults = [
            ...
            'attendance_record' => ['fields' => ['id', 'employee_name', 'store_name', 'clock_in', 'clock_out', 'status'], 'actions' => ['view', 'edit'], 'action_urls' => ['view' => '/admin/attendance?record={id}', 'edit' => '/admin/attendance?record={id}'], 'limit' => 30, 'empty_state' => 'No attendance records found.'],
            'employee_profile' => ['fields' => ['id', 'name', 'position', 'department', 'salary_type', 'employment_status'], 'actions' => ['edit'], 'action_urls' => ['edit' => '/admin/wage/employees/{id}'], 'limit' => 25, 'empty_state' => 'No employee profiles yet.'],
            'payroll_period' => ['fields' => ['id', 'period_name', 'start_date', 'end_date', 'status', 'total_net_pay'], 'actions' => ['view'], 'action_urls' => ['view' => '/admin/wage/reports/{id}'], 'limit' => 12, 'empty_state' => 'No payroll periods yet.'],
            'salary_computation' => ['fields' => ['id', 'employee_name', 'period_name', 'gross_pay', 'total_deductions', 'net_pay', 'status'], 'actions' => ['view', 'approve'], 'action_urls' => ['view' => '/admin/wage/computations?id={id}', 'approve' => '/admin/wage/computations?id={id}'], 'limit' => 25, 'empty_state' => 'No salary computations found.'],
            'salary_adjustment' => ['fields' => ['id', 'employee_name', 'adjustment_type', 'amount', 'status', 'effective_date', 'approval_date', 'applied_date'], 'actions' => ['edit', 'view', 'approve'], 'action_urls' => ['edit' => '/admin/wage/adjustments/{id}', 'view' => '/admin/wage/adjustments/{id}', 'approve' => '/api/v1/wage/adjustments/{id}/approve'], 'action_methods' => ['approve' => 'post'], 'action_confirm' => ['approve' => 'Approve this adjustment?'], 'action_show_if' => ['edit' => 'status == "pending"', 'view' => 'status != "pending"', 'approve' => 'status == "pending"'], 'limit' => 20, 'empty_state' => 'No salary adjustments found.'],
            'employee_deduction' => ['fields' => ['id', 'employee_name', 'amount', 'description', 'status', 'deduction_date', 'source'], 'actions' => ['view'], 'action_urls' => ['view' => '/admin/wage/deductions?id={id}'], 'limit' => 20, 'empty_state' => 'No employee deductions found.'],
            'holiday' => ['fields' => ['id', 'holiday_name', 'holiday_date', 'holiday_type', 'pay_multiplier'], 'actions' => ['edit', 'delete'], 'action_urls' => ['edit' => '/admin/wage/holidays?edit={id}', 'delete' => '/api/v1/wage/holidays/{id}/delete'], 'action_methods' => ['delete' => 'post'], 'action_confirm' => ['delete' => 'Delete this holiday?'], 'limit' => 30, 'empty_state' => 'No holidays configured.'],
            'cash_advance' => ['fields' => ['id', 'employee_name', 'amount', 'balance', 'status', 'request_date', 'approved_at'], 'actions' => ['view', 'approve'], 'action_urls' => ['view' => '/admin/wage/cash-advances?id={id}', 'approve' => '/api/v1/wage/cash-advances/{id}/approve'], 'action_methods' => ['approve' => 'post'], 'action_show_if' => ['approve' => 'status == "pending"'], 'limit' => 20, 'empty_state' => 'No cash advance requests.'],
            'employee_schedule' => ['fields' => ['id', 'employee_name', 'position', 'department', 'days_label', 'shift_type', 'dayoff_count', 'total_days'], 'actions' => ['edit'], 'action_urls' => ['edit' => '/admin/wage/schedules?id={id}'], 'limit' => 30, 'empty_state' => 'No employee schedules yet.'],
            'office_location' => ['fields' => ['id', 'name', 'address', 'latitude', 'longitude', 'radius_meters', 'is_active'], 'actions' => ['edit', 'delete'], 'action_urls' => ['edit' => '/admin/wage/locations/{id}', 'delete' => '/api/v1/wage/locations/{id}/delete'], 'action_methods' => ['delete' => 'post'], 'action_confirm' => ['delete' => 'Delete this location?'], 'limit' => 50, 'empty_state' => 'No office locations configured yet.'],
        ];
