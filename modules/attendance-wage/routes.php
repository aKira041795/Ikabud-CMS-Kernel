...
return [
    'GET' => [
        ...
        '/admin/wage/periods/{id}/edit'  => 'attendance-wage:wagePagePeriodForm',
        '/admin/wage/computations'       => 'attendance-wage:wagePageComputations',
        '/admin/wage/computations/{id}'  => 'attendance-wage:wagePageComputationDetail',
        ...
        '/admin/wage/cash-advances/{id}' => 'attendance-wage:wagePageCashAdvances',
        ...
        '/admin/wage/holidays/{id}'      => 'attendance-wage:wagePageHolidays',
        '/admin/wage/holidays/{id}/edit' => 'attendance-wage:wagePageHolidays',
        ...
        '/admin/wage/locations/{id}/edit' => 'attendance-wage:wagePageLocationForm',
        ...
        '/api/v1/wage/settings/backup/download' => 'attendance-wage:wageApiSettingsBackupDownload',
    ...
    'POST' => [
        ...
        '/api/v1/wage/settings/backup'          => 'attendance-wage:wageApiSettingsBackupGenerate',
