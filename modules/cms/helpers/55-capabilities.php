...
function cms_capability_handlers(): array
{
    return [
        ...
        'entity.capability.progress_tracking.data@1'  => 'cms_cap_entity_capability_progress_tracking_data_1',
        'entity.capability.lessons_index.data@1'      => 'cms_cap_entity_capability_lessons_index_data_1',
