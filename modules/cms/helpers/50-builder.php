...
function cmsBuilderValidateDocument(mixed $document): array
{
    ...
    $allowedTypes = [
        ...
        'anchor', 'breadcrumbs', 'posts_grid', 'products_grid', 'team_grid',
    ];
...
function cmsBuilderDefaultProps(string $type): array
{
    static $defaults = [
        ...
        'gallery'        => ['images' => [], 'columns' => 3, 'gap' => 16],
        ...
        'call_to_action' => ['title' => 'Ready to Get Started?', 'description' => 'Join thousands of satisfied customers.', 'buttonText' => 'Start Free Trial', 'buttonUrl' => '#', 'layout' => 'horizontal'],
        ...
        'search_box'     => ['placeholder' => 'Search...', 'buttonText' => 'Search', 'showButton' => true, 'searchUrl' => '/search'],
        'code_block'     => ['code' => '// Code here', 'language' => 'javascript', 'showLineNumbers' => true, 'theme' => 'dark'],
        'pricing_table'  => ['planName' => 'Professional', 'price' => '49', 'currency' => '$', 'period' => '/month', 'buttonText' => 'Get Started', 'buttonUrl' => '#'],
        ...
        'map'            => ['address' => '', 'zoom' => 14, 'height' => '400px'],
