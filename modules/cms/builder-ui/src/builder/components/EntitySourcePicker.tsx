  ...
  return (
    <div className="space-y-2">
      ...
      {showValidation && validation && (
        <div className={`p-2 rounded-md text-[10px] space-y-1 ${
          validation.valid ? 'bg-green-400/5 border border-green-400/20' : 'bg-yellow-400/5 border border-yellow-400/20'
        }`}>
