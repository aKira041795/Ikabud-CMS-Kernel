...
final class HarppFoundationService
{
    ...
    public function dispatchOutbox(int $limit=50): HarppServiceResult
    {
        ...
        $stmt=$this->database->query("SELECT id,event_name,payload_json,attempts FROM harpp_outbox WHERE status='pending' AND available_at<=NOW(6) ORDER BY id ASC LIMIT ".$limit);
