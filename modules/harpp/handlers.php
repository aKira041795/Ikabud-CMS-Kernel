...
function harppConversationDeleteMessages(array $params=[]):void { harppHandle(function()use($params):void{harppRequireCsrf();$u=harppAuthenticated('harpp.read@1');if($u)harppJson((new HarppMessagingService())->deleteAllMessages($u,(int)($params['id']??0),harppCurrentTenantId()));}); }
