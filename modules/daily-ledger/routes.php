...
return [
    'GET' => [
        ...
        '/daily-ledger/admin/reports/variances'    => 'daily-ledger:handleAdminReportVariances',
        '/daily-ledger/admin/reports/variances/export' => 'daily-ledger:handleAdminReportVariancesExport',
        '/daily-ledger/admin/reports/branch-summary' => 'daily-ledger:handleAdminReportBranchSummary',
        '/daily-ledger/admin/reports/branch-summary/export' => 'daily-ledger:handleAdminReportBranchSummaryExport',
        '/daily-ledger/admin/reports/month-end'    => 'daily-ledger:handleAdminReportMonthEnd',
        '/daily-ledger/admin/reports/month-end/export' => 'daily-ledger:handleAdminReportMonthEndExport',
        '/daily-ledger/admin/reports/category-sales' => 'daily-ledger:handleAdminReportCategorySales',
        '/daily-ledger/admin/reports/category-sales/export' => 'daily-ledger:handleAdminReportCategorySalesExport',
        '/daily-ledger/admin/reports/data-integrity' => 'daily-ledger:handleAdminReportDataIntegrity',
        '/daily-ledger/admin/reports/data-integrity/export' => 'daily-ledger:handleAdminReportDataIntegrityExport',
        '/daily-ledger/admin/forecast'             => 'daily-ledger:handleAdminForecast',
