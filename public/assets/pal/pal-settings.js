...
(function () {
    ...
    window.addCategory = function (type, inputId) {
        ...
        window.ajaxPost(window.PalRoutes.action('settings.category'), 'type=' + encodeURIComponent(type) + '&name=' + encodeURIComponent(name), 'Added');
    };
    ...
    window.addUnit = function () {
        ...
        window.ajaxPost(window.PalRoutes.action('settings.category'), 'type=unit&name=' + encodeURIComponent(name) + '&abbreviation=' + encodeURIComponent(abbr), 'Added');
    };
    ...
    window.addTeamLead = function () {
        ...
        window.ajaxPost(window.PalRoutes.action('settings.category'), 'type=team_lead&name=' + encodeURIComponent(name) + '&contact_number=' + encodeURIComponent(contact) + '&email=' + encodeURIComponent(email), 'Added');
    };
    ...
    window.addInvLocation = function () {
        ...
        window.ajaxPost(window.PalRoutes.action('settings.category'), 'type=inventory_location&name=' + encodeURIComponent(name) + '&description=' + encodeURIComponent(desc), 'Added');
    };
    ...
    window.addSupplier = function () {
        ...
        window.ajaxPost(window.PalRoutes.action('settings.supplier'), 'name=' + encodeURIComponent(name) + '&contact_person=' + encodeURIComponent(cp) + '&email=' + encodeURIComponent(email), 'Added');
    };
    ...
    window.toggleStatus = function (type, id) {
        ...
        fetch(window.PalRoutes.action('settings.toggle', id), {
