...
echo "Dry-run the profile-bound deployment (no connection):\n";
echo "  python3 tools/harpp-bridge/deploy_harpp.py " . escapeshellarg($outputPath) . "\n";
echo "Add --execute only after reviewing the receipt and profile.\n\n";
echo "After upload:\n";
