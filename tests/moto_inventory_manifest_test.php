...
$expectedTables = [
    ...
    'moto_import_rows', 'moto_import_templates', 'moto_audit_log', 'moto_idempotency_keys',
...
$h->test('six migrations declared', is_array($migrations) && count($migrations) === 6);
$expectedMigrations = [
