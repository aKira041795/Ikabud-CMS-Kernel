...
t('native canonical CMS list uses CMS-facing summary copy', str_contains($nativeCanonicalBlogHtml, 'Blog Snapshot') && str_contains($nativeCanonicalBlogHtml, 'Canonical CMS List') && str_contains($nativeCanonicalBlogHtml, 'Blog Home') && !str_contains($nativeCanonicalBlogHtml, 'Catalog Snapshot'), $nativeCanonicalBlogHtml);
...
t('canonical storefront product render uses human-facing summary copy', str_contains($storefrontCanonicalProductHtml, 'Product Snapshot') && str_contains($storefrontCanonicalProductHtml, 'Canonical Product View') && str_contains($storefrontCanonicalProductHtml, 'Product Detail') && str_contains($storefrontCanonicalProductHtml, '>Bread<'), $storefrontCanonicalProductHtml);
