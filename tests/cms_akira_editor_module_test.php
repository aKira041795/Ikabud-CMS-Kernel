<?php
/**
 * Cms Akira Editor Module — Scaffold Test
 *
 * Verifies module bootstrap, context availability, and basic contract compliance.
 * Run: php tests/cms_akira_editor_module_test.php
 */
...
echo "── Manifest ──
";
$manifestPath = BASE_PATH . '/modules/cms-akira/cms-akira-editor/module.json';
t('module.json exists', is_file($manifestPath));

$manifest = json_decode((string)file_get_contents($manifestPath), true);
t('module.json is valid JSON', is_array($manifest));
t('module id matches', ($manifest['id'] ?? '') === 'cms-akira-editor');
...
";
$all = discoverModules();
t('Module discovered by kernel', isset($all['cms-akira-editor']));
...
── Routes ──
";
$modulePath = BASE_PATH . '/modules/cms-akira/cms-akira-editor';
...
t('caeCtx function exists', function_exists('caeCtx'));
t('caeDb function exists', function_exists('caeDb'));
t('caeInput function exists', function_exists('caeInput'));
t('caeRender function exists', function_exists('caeRender'));
