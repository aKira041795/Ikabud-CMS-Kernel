...
echo "── Manifest ──
";
$manifestPath = BASE_PATH . '/modules/cms-akira/cms-akira-ai/module.json';
t('module.json exists', is_file($manifestPath));

$manifest = json_decode((string)file_get_contents($manifestPath), true);
t('module.json is valid JSON', is_array($manifest));
t('module id matches', ($manifest['id'] ?? '') === 'cms-akira-ai');
...
";
$all = discoverModules();
t('Module discovered by kernel', isset($all['cms-akira-ai']));
...
── Routes ──
";
$modulePath = BASE_PATH . '/modules/cms-akira/cms-akira-ai';
...
t('caaCtx function exists', function_exists('caaCtx'));
t('caaDb function exists', function_exists('caaDb'));
t('caaInput function exists', function_exists('caaInput'));
t('caaRender function exists', function_exists('caaRender'));
