<?php
/**
 * Cms Akira Profile Visual Module — Scaffold Test
 *
 * Verifies module bootstrap, context availability, and basic contract compliance.
 * Run: php tests/cms_akira_profile_visual_module_test.php
 */
...
echo "
=== Cms Akira Profile Visual MODULE TEST ===
...
echo "── Manifest ──
";
$manifestPath = BASE_PATH . '/modules/cms-akira/cms-akira-profile-visual/module.json';
t('module.json exists', is_file($manifestPath));

$manifest = json_decode((string)file_get_contents($manifestPath), true);
t('module.json is valid JSON', is_array($manifest));
t('module id matches', ($manifest['id'] ?? '') === 'cms-akira-profile-visual');
...
";
$all = discoverModules();
t('Module discovered by kernel', isset($all['cms-akira-profile-visual']));
...
── Routes ──
";
$modulePath = BASE_PATH . '/modules/cms-akira/cms-akira-profile-visual';
...
t('capvCtx function exists', function_exists('capvCtx'));
t('capvDb function exists', function_exists('capvDb'));
t('capvInput function exists', function_exists('capvInput'));
t('capvRender function exists', function_exists('capvRender'));
