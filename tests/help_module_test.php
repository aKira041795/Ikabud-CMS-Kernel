...
";
$all = discoverModules();
t('Module discovered by kernel', isset($all['help']));
...
── Routes ──
";
$modulePath = BASE_PATH . '/modules/help';
...
t('hCtx function exists', function_exists('hCtx'));
t('hDb function exists', function_exists('hDb'));
t('hInput function exists', function_exists('hInput'));
t('hRender function exists', function_exists('hRender'));
