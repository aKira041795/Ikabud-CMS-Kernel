...
| AGT-007 | CMS Akira suite decomposition + product-suite/extension model docs alignment | ✅ done | P1 | Documentation Writer | Suite (14 submodules) + additive suite fields + dynamic sidebar + DiSyL JSON; release note 2026-08-05 |
