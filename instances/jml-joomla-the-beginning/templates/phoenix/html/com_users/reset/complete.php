<?php
/**
 * Phoenix Template Override - Password Reset Complete
 * @package     Phoenix
...
<div class="phoenix-form-container">
    <div class="phoenix-form-card">
        ...
        <?php else : ?>
            <h1 class="phoenix-form-title"><?php echo Text::_('COM_USERS_RESET_COMPLETE'); ?></h1>
        <?php endif; ?>
        
        <p class="phoenix-form-description">
            <?php echo Text::_('COM_USERS_RESET_COMPLETE_DESCRIPTION'); ?>
        </p>
        
        <form action="<?php echo Route::_('index.php?option=com_users&task=reset.complete'); ?>" method="post" class="phoenix-form form-validate">
...
.phoenix-form .controls input[type="password"] {
    width: 100%;
